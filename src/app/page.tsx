          ...
          <div className="flex flex-col md:flex-row items-center">
            <div className="md:w-1/2 mb-10 md:mb-0">
              <h1 className="text-4xl md:text-5xl font-bold mb-4">
                Tu restaurante favorito, ahora online
              </h1>
              <p className="text-xl mb-8">
                Ordena tus platos favoritos con solo unos clics. Delivery rápido y seguro.
              </p>
        ...
        <div className="container mx-auto px-4">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            <div className="bg-white p-6 rounded-lg shadow-md text-center">
              ...
              <p className="text-gray-600">Recibe tu pedido en tiempo récord, siempre caliente y fresco.</p>
            </div>
            <div className="bg-white p-6 rounded-lg shadow-md text-center">
              <div className="w-16 h-16 bg-primary-100 rounded-full flex items-center justify-center mx-auto mb-4">
                <svg className="w-8 h-8 text-primary-600" fill="none" stroke="currentColor" viewBox="0 0 24 24">
              ...
              <p className="text-gray-600">Utilizamos ingredientes frescos y de la mejor calidad.</p>
            </div>
            <div className="bg-white p-6 rounded-lg shadow-md text-center">
              <div className="w-16 h-16 bg-primary-100 rounded-full flex items-center justify-center mx-auto mb-4">
                <svg className="w-8 h-8 text-primary-600" fill="none" stroke="currentColor" viewBox="0 0 24 24">
              ...
              <p className="text-gray-600">Múltiples opciones de pago con total seguridad.</p>
            </div>
          </div>
        </div>
      </section>
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6">
            <div className="relative h-64 rounded-lg overflow-hidden group">
              ...
              <div className="absolute inset-0 bg-black bg-opacity-40 flex items-center justify-center">
                <h3 className="text-white text-2xl font-bold">Pizzas</h3>
              </div>
            </div>
            <div className="relative h-64 rounded-lg overflow-hidden group">
              <Image
                src="/images/category-burger.jpg"
                alt="Hamburguesas"
                fill
                className="object-cover transition-transform duration-300 group-hover:scale-110"
              />
              <div className="absolute inset-0 bg-black bg-opacity-40 flex items-center justify-center">
                <h3 className="text-white text-2xl font-bold">Hamburguesas</h3>
              </div>
            </div>
            <div className="relative h-64 rounded-lg overflow-hidden group">
              <Image
                src="/images/category-pasta.jpg"
                alt="Pastas"
                fill
                className="object-cover transition-transform duration-300 group-hover:scale-110"
              />
              <div className="absolute inset-0 bg-black bg-opacity-40 flex items-center justify-center">
                <h3 className="text-white text-2xl font-bold">Pastas</h3>
              </div>
            </div>
            <div className="relative h-64 rounded-lg overflow-hidden group">
              <Image
              ...
              />
              <div className="absolute inset-0 bg-black bg-opacity-40 flex items-center justify-center">
                <h3 className="text-white text-2xl font-bold">Postres</h3>
              </div>
            </div>
          </div>
      ...
      <section className="py-16 bg-primary-600 text-white">
        <div className="container mx-auto px-4 text-center">
          ...
          <p className="text-xl mb-8 max-w-2xl mx-auto">
            Únete a miles de clientes satisfechos y disfruta de la mejor comida a un solo clic.
          </p>
          <Link href="/menu" className="btn bg-white text-primary-600 hover:bg-gray-100">
            Ordenar Ahora
          </Link>
        </div>
      </section>
